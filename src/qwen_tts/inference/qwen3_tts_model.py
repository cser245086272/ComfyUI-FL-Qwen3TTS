        ...
        **kwargs,
        ...
        Args:
            ...
            progress_callback:
                ...
                Signature: progress_callback(stage: str, current: int, total: int)
                Stages: "tokenizing", "extract_speaker", "generating", "decoding"
            **kwargs:
        ...
        if progress_callback:
            progress_callback("generating", 0, gen_kwargs.get("max_new_tokens", 2048))
        ...
        if progress_callback:
            ...
            progress_callback("generating", max_tokens, max_tokens)
        ...
        if progress_callback:
            progress_callback("decoding", 1, 1)
        ...
        **kwargs,
        ...
        Args:
            ...
            progress_callback:
                Optional callback function for progress reporting.
                Signature: progress_callback(stage: str, current: int, total: int)
                Stages: "tokenizing", "generating", "decoding"
            **kwargs:
                Any other keyword arguments supported by HuggingFace Transformers `generate()` can be passed.
                They will be forwarded to the underlying `Qwen3TTSForConditionalGeneration.generate(...)`.
